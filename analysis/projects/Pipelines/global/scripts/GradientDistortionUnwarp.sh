...
echo "/disk/HCP/pipeline/external/Python-3.5.2/bin/bin/python3.5 /disk/HCP/pipeline/external/gradunwarp/gradunwarp/core/gradient_unwarp.py ${BaseName}_vol1.nii.gz trilinear.nii.gz siemens -g $InputCoeffs -n"
/disk/HCP/pipeline/external/Python-3.5.2/bin/bin/python3.5 /disk/HCP/pipeline/external/gradunwarp/gradunwarp/core/gradient_unwarp.py ${BaseName}_vol1.nii.gz trilinear.nii.gz siemens -g $InputCoeffs -n
cd $ORIGDIR
