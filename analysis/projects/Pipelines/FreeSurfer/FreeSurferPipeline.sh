...
fsflags=`opts_GetOpt1 "--flags" $@` #additional FS flags


export fsflags=`echo "${fsflags}" | sed 's/@/ /g'`
echo ${fsflags}
...
#recon-all -subjid $SubjectID -sd $SubjectDIR -motioncor -talairach -nuintensitycor -normalization ${fsflags}
recon-all -i "$T1wImageFile"_1mm.nii.gz -subjid $SubjectID -sd $SubjectDIR -motioncor -talairach -nuintensitycor -normalization ${fsflags}
...
recon-all -subjid $SubjectID -sd $SubjectDIR -autorecon2 -nosmooth2 -noinflate2 -nocurvstats -nosegstats -openmp 8 ${fsflags}
...
recon-all -subjid $SubjectID -sd $SubjectDIR -smooth2 -inflate2 -curvstats -sphere -surfreg -jacobian_white -avgcurv -cortparc ${fsflags}
...
recon-all -subjid $SubjectID -sd $SubjectDIR -surfvolume -parcstats -cortparc2 -parcstats2 -cortparc3 -parcstats3 -cortribbon -segstats -aparc2aseg -wmparc -balabels -label-exvivo-ec  ${fsflags} 
