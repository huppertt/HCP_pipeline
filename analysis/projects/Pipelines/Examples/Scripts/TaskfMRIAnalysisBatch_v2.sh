...
if [ -n "${command_line_specified_tasklist}" ]; then
    TaskNameList="${command_line_specified_tasklist}"
else
    TaskNameList=""
    #TaskNameList="${TaskNameList} BOLD_EMOTION"
    #TaskNameList="${TaskNameList} BOLD_GAMBLING"
    TaskNameList="${TaskNameList} BOLD_LANGUAGE"
    TaskNameList="${TaskNameList} BOLD_MOTOR"
    #TaskNameList="${TaskNameList} BOLD_RELATIONAL"
    #TaskNameList="${TaskNameList} BOLD_SOCIAL"
    TaskNameList="${TaskNameList} BOLD_WM"
...
do
	LevelOneTasksList="${TaskName}" #Delimit runs with @ and tasks with space
	LevelOneFSFsList="${TaskName}" #Delimit runs with @ and tasks with space
	LevelTwoTaskList="${TaskName}" #Space delimited list
	LevelTwoFSFList="${TaskName}" #Space delimited list
