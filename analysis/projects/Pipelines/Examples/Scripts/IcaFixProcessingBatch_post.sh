		...
		do
			...
			do
                ...
                if [ -f $InputFile ] ; then
                    ...
                    if [ "${RunLocal}" == "TRUE" ]
                    then
                        echo "About to run ${FixDir}/hcp_fix_post ${InputFile} ${bandpass}"
                        queuing_command=""
                    else
                        echo "About to use fsl_sub to queue or run ${FixDir}/hcp_fix_post ${InputFile} ${bandpass}"
                        queuing_command="${FSLDIR}/bin/fsl_sub ${QUEUE}"
                    fi
                    
                    ${queuing_command} ${FixDir}/hcp_fix_post ${InputFile} ${bandpass}
                fi
			done
