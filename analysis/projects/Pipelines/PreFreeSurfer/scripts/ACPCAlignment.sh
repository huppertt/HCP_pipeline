...
${FSLDIR}/bin/fixFLIRT.sh "$WD"/roi2full.mat > "$WD"/roi2full2.mat
mv "$WD"/roi2full2.mat "$WD"/roi2full.mat
...
${FSLDIR}/bin/fixFLIRT.sh "$WD"/roi2std.mat > "$WD"/roi2full2.mat
mv "$WD"/roi2full2.mat "$WD"/roi2std.mat
...
echo ${FSLDIR}/bin/aff2rigid "$WD"/full2std.mat "$OutputMatrix"
