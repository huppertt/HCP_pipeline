...
if(exist(fullfile(outfolder,subjid,'MNINonLinear','ribbon.nii.gz'))==0)
    system(['source ' HCProot '/pipeline/projects/Pipelines/Examples/Scripts/PostFreeSurferPipelineBatch2.sh --runlocal --StudyFolder=' outfolder ' --Subjlist="' subjid '"'])
end
