function HCP_rfMRI_MMP_conn_matrix_alldays_clean(subjid,outfolder,force)
...
if exist(fullfile(outfolder,subjid,'T1w',subjid,'dmri',[subjid '_rfMRI_conn_matrices_alldays_clean.mat'])) & ~force
...
for i = 1:8
    ...
    for j = 1:376
        data.BOLD(:,j) = tc_data(i).clean_tc(j).dat';
    end
...
save(fullfile(outfolder,subjid,'T1w',subjid,'dmri',[subjid '_rfMRI_conn_matrices_alldays_clean.mat']),...
    'conn_data')