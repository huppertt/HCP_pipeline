function HCP_rfMRI_MMP_conn_matrix(subjid,outfolder,force)
...
if exist(fullfile(outfolder,subjid,'T1w',subjid,'dmri',[subjid '_rfMRI_conn_matrices.mat'])) & ~force
...
save(fullfile(outfolder,subjid,'T1w',subjid,'dmri',[subjid '_rfMRI_conn_matrices.mat']),...
