...
echo "/aionraid/huppertt/raid2_BU/HCP/pipeline/external/Python-3.9.9/python3.9 /disk/HCP/pipeline/external/gradunwarp/gradunwarp/core/gradient_unwarp.py ${BaseName}_vol1.nii.gz trilinear.nii.gz siemens -g $InputCoeffs -n"
/aionraid/huppertt/raid2_BU/HCP/pipeline/external/Python-3.9.9/bin/python3.9 /aionraid/huppertt/raid2_BU/HCP/pipeline/external/gradunwarp/gradunwarp/core/gradient_unwarp.py ${BaseName}_vol1.nii.gz trilinear.nii.gz siemens -g $InputCoeffs -n
cd $ORIGDIR
