...
#   if [ ! -e ${CommonAtlasFolder}/fsaverage_LR${LowResMesh}k ] ; then
#		mkdir -p ${CommonAtlasFolder}/fsaverage_LR${LowResMesh}k
#	else 
#		rm -r ${CommonAtlasFolder}/fsaverage_LR${LowResMesh}k
#		mkdir -p ${CommonAtlasFolder}/fsaverage_LR${LowResMesh}k
#	fi
 ...
 #   cp --verbose ${AtlasFolder}/fsaverage_LR32k/${Subject}.thickness.${LowResMesh}k_fs_LR.dscalar.nii ${CommonDownSampleFolder}/${GroupAverageName}.thickness.${LowResMesh}k_fs_LR.dscalar.nii
 #   cp --verbose ${AtlasFolder}/fsaverage_LR32k/${Subject}.R.sphere.${LowResMesh}k_fs_LR.surf.gii ${CommonDownSampleFolder}/${GroupAverageName}.R.sphere.${LowResMesh}k_fs_LR.surf.gii
 #   cp --verbose ${AtlasFolder}/fsaverage_LR32k/${Subject}.L.sphere.${LowResMesh}k_fs_LR.surf.gii ${CommonDownSampleFolder}/${GroupAverageName}.L.sphere.${LowResMesh}k_fs_LR.surf.gii
