    ...
    NegData="${RawDataDir}/${SubjectID}_3T_DWI_dir95_LR.nii.gz@${RawDataDir}/${SubjectID}_3T_DWI_dir96_LR.nii.gz@${RawDataDir}/${SubjectID}_3T_DWI_dir97_LR.nii.gz"
       ...
       # PosData="${RawDataDir}/${SubjectID}_3T_DWI_dir95_AP.nii.gz@${RawDataDir}/${SubjectID}_3T_DWI_dir96_AP.nii.gz@${RawDataDir}/${SubjectID}_3T_DWI_dir97_AP.nii.gz"
        if [ -f ${RawDataDir}/${SubjectID}_3T_DWI_dir98_AP.nii.gz ] && [ -f ${RawDataDir}/${SubjectID}_3T_DWI_dir98_PA.nii.gz ]; then
            PosData="${RawDataDir}/${SubjectID}_3T_DWI_dir99_AP.nii.gz@${RawDataDir}/${SubjectID}_3T_DWI_dir98_AP.nii.gz@EMPTY"
            NegData="${RawDataDir}/${SubjectID}_3T_DWI_dir99_PA.nii.gz@${RawDataDir}/${SubjectID}_3T_DWI_dir98_PA.nii.gz@EMPTY"
        else
            PosData="${RawDataDir}/${SubjectID}_3T_DWI_dir99_AP.nii.gz@EMPTY@EMPTY"
            NegData="${RawDataDir}/${SubjectID}_3T_DWI_dir99_PA.nii.gz@EMPTY@EMPTY"
        fi
        PEdir=2
   elif [ -f ${RawDataDir}/${SubjectID}_3T_DWI_dir98_AP.nii.gz ] && [ -f ${RawDataDir}/${SubjectID}_3T_DWI_dir98_PA.nii.gz ]; then
       # PosData="${RawDataDir}/${SubjectID}_3T_DWI_dir95_AP.nii.gz@${RawDataDir}/${SubjectID}_3T_DWI_dir96_AP.nii.gz@${RawDataDir}/${SubjectID}_3T_DWI_dir97_AP.nii.gz"
       PosData="EMPTY@${RawDataDir}/${SubjectID}_3T_DWI_dir98_AP.nii.gz@EMPTY"
       NegData="EMPTY@${RawDataDir}/${SubjectID}_3T_DWI_dir98_PA.nii.gz@EMPTY"
       PEdir=2
  elif [ -f ${RawDataDir}/${SubjectID}_3T_DWI_dir68_AP.nii.gz ]; then
       PosData="EMPTY@${RawDataDir}/${SubjectID}_3T_DWI_dir68_AP.nii.gz@EMPTY"
       ...
       PosData="EMPTY@${RawDataDir}/${SubjectID}_3T_DWI_dir113_AP.nii.gz@EMPTY"
