function HCP_rfMRI_MMP_conn_matrix_day2(subjid,outfolder,force)
...
if exist(fullfile(outfolder,subjid,'T1w',subjid,'dmri',[subjid '_rfMRI_conn_matrices_d2.mat'])) & ~force
...
for j = 1:376
    data.BOLD(:,j) = tc_data(5).raw_tc(j).dat';
end
...
save(fullfile(outfolder,subjid,'T1w',subjid,'dmri',[subjid '_rfMRI_conn_matrices_d2.mat']),...
