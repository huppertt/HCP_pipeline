...
${FSLDIR}/bin/fixFLIRT.sh "$WD"/roi2full.mat >> "$WD"/tmp.mat
mv "$WD"/tmp.mat "$WD"/roi2full.mat
${FSLDIR}/bin/convert_xfm -omat "$WD"/full2roi.mat -inverse "$WD"/roi2full.mat

${FSLDIR}/bin/fixFLIRT.sh "$WD"/full2roi.mat >> "$WD"/tmp.mat
mv "$WD"/tmp.mat "$WD"/full2roi.mat
...
${FSLDIR}/bin/fixFLIRT.sh "$WD"/roi2std.mat >> "$WD"/tmp.mat
mv "$WD"/tmp.mat "$WD"/roi2std.mat
...
${FSLDIR}/bin/fixFLIRT.sh "$WD"/full2std.mat >> "$WD"/tmp.mat
mv "$WD"/tmp.mat "$WD"/full2std.mat
