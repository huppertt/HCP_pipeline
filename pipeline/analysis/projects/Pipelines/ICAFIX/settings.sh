...
FSL_FIX_MATLAB_ROOT=/home/pkg/master/MATLAB/R2014a/
# =======================
...
# WUSTL CHPC Cluster 2.0 setting
FSL_FIX_MCRROOT=/home/pkg/master/MATLAB/R2014a/
...
FSL_FIX_CIFTIRW='/disk/HCP/pipeline/analysis/cifti/ft_read_cifti';
...
FSL_FIX_WBC='/disk/HCP/pipeline/workbench/bin_linux64/wb_command'
