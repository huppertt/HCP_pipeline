...
export HCPPIPEDIR=${HOME}/pipeline/projects/Pipelines
export CARET7DIR=${HOME}/pipeline/workbench/bin_linux64
...
export MSMBin=/aionraid/huppertt/raid2_BU/HCP/pipeline/external/MSM_HOCR_v1/Centos/
