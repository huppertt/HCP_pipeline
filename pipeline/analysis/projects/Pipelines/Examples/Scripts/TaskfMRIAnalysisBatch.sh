...
do
	LevelOneTasksList="BOLD_${TaskName}1_AP@BOLD_${TaskName}2_PA" #Delimit runs with @ and tasks with space
	LevelOneFSFsList="BOLD_${TaskName}1_AP@BOLD_${TaskName}2_PA" #Delimit runs with @ and tasks with space
	LevelTwoTaskList="BOLD_${TaskName}" #Space delimited list
	LevelTwoFSFList="BOLD_${TaskName}" #Space delimited list
