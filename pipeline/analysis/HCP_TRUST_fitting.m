...
if force == 0 & exist(fullfile(outfolder,subjid,'TRUST', [subjid '_TRUST_fit.mat']),'file')
...
%     DiffPCA = (niipca.vol(:,:,:,4)-nifipca.vol(:,:,:,3));
    ...
    save(fullfile(outfolder,subjid,'TRUST', [subjid '_TRUST_fit.mat']), 'Y_v', 'T2','Signal_mask','R2');
