...
%
%   $Header: /space/orsay/8/users/msh/CVS/CVS-MSH/MNE/mne_matlab/mne_write_cov.m,v 1.3 2006/05/05 03:50:40 msh Exp $
%   $Log: mne_write_cov.m,v $
...
%
if cov.diag
    fiff_write_double(fid,FIFF.FIFF_MNE_COV_DIAG,diag(cov.data));
else
    q = 1;
