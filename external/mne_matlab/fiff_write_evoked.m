...
%
% $Header: /space/orsay/8/users/msh/CVS/CVS-MSH/MNE/mne_matlab/fiff_write_evoked.m,v 1.11 2006/10/04 20:12:37 msh Exp $
% $Log: fiff_write_evoked.m,v $
...
fiff_start_block(fid,FIFF.FIFFB_MEAS);
    ...
    elseif ~isempty(data.info.file_id)
       fiff_write_id(fid,FIFF.FIFF_PARENT_FILE_ID,data.info.file_id);
    end
    %
    %    Measurement info
    %
    fiff_start_block(fid,FIFF.FIFFB_MEAS_INFO);
	 ...
	 %
	 %    Coordinate transformations and channel info
	 %
