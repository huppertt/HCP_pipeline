...
%
%   $Header: /space/orsay/8/users/msh/CVS/CVS-MSH/MNE/mne_matlab/fiff_write_ch_info.m,v 1.6 2006/04/23 15:29:40 msh Exp $
%   $Log: fiff_write_ch_info.m,v $
...
count = fwrite(fid,ch.ch_name,'char');
if count ~= len
    error(me,'write failed');
end
if len < 16
