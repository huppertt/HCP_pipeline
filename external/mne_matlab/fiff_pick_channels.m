...
%
%
%   $Header: /space/orsay/8/users/msh/CVS/CVS-MSH/MNE/mne_matlab/fiff_pick_channels.m,v 1.4 2006/06/29 22:12:28 msh Exp $
%   $Log: fiff_pick_channels.m,v $
...
if isempty(include)
   ...
   for k = 1:length(include)
      ...
      if length(c) ~= 1
	 error(me,'Missing or ambiguous channel %s',include{k});
      else
	 %
