...
%
%   $Header: /space/orsay/8/users/msh/CVS/CVS-MSH/MNE/mne_matlab/mne_read_forward_solution.m,v 1.9 2006/11/30 05:43:29 msh Exp $
%   $Log: mne_read_forward_solution.m,v $
...
if fwd.source_ori == FIFF.FIFFV_MNE_FIXED_ORI || ...
    ...
    if fwd.source_ori ~= FIFF.FIFFV_MNE_FIXED_ORI
        ...
        fwd.sol.data   = fwd.sol.data*mne_block_diag(fwd.source_nn',1);
    ...
    if surf_ori
        ...
        fwd.sol.data = fwd.sol.data*mne_block_diag(fwd.source_nn',3);
        fprintf(1,'[done]\n');
    else
