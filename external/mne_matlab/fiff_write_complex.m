...
%
%   $Header: /space/orsay/8/users/msh/CVS/CVS-MSH/MNE/mne_matlab/fiff_write_complex.m,v 1.1 2006/09/23 14:43:56 msh Exp $
%   $Log: fiff_write_complex.m,v $
...
count = fwrite(fid,int32(FIFFT_COMPLEX),'int32');
if count ~= 1
    error(me,'write failed');
end
