...
%
%   $Header: /space/orsay/8/users/msh/CVS/CVS-MSH/MNE/mne_matlab/fiff_write_id.m,v 1.4 2006/04/23 15:29:40 msh Exp $
%   $Log: fiff_write_id.m,v $
...
if nargin ==2
   ...
   id.version   = bitor(bitshift(1,16),1);  %   Version (1 << 16) | 1
